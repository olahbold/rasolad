  ...
  return (
    <div className="ProjectGalleryContainer">
      ...
      <div className = 'galleryItem'>
        <h2 className = 'itemText'>CBN PROJECT</h2>
        <div className = 'imageWrappper'>
          <img src="public\rasolad_images\Lightning_arrestor\lightning1.jpg" alt=""   className = 'imageItemConfig'/>
          <img src="public\rasolad_images\Lightning_arrestor\lightning1.jpg" alt=""   className = 'imageItemConfig'/>
          <img src="public\rasolad_images\Lightning_arrestorlightning1.jpg" alt=""   className = 'imageItemConfig' />
        </div>
      </div>
