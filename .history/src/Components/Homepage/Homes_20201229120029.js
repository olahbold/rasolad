  ...
  return (
    <div className="Homepage_services">
      <div className="gallery">
        ...
        <div className="desc">MANUFACTURING/FABRICATION</div>
      </div>
      ...
      <div className="gallery">
        ...
        <div className = 'overlay'> <div className="desc">SALES</div></div>
      ...
      <div className="gallery">
        ...
        <div className="desc">INSTALLATIONS</div>
      </div>
      ...
      <div className="gallery">
        ...
        <div className="desc">IMPORTATION/REPRESENTATIVE</div>
      </div>
    </div>
  );
}
