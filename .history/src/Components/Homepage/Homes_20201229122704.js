  ...
  return (
    <div className="Homepage_services">
      <div className="gallery">
        <a href="/services">
          <img src="image4.jpg" alt="Forest" width="400" height="300" className = 'galleryImage' />
        </a>
      ...
      <div className="gallery">
        <a target="_blank" href = '/services'>
          <img src="image7.jpg" alt="Cinque Terre" width="400" height="300" className = 'galleryImage' />
        </a>
